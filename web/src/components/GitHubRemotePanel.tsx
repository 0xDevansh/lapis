...
import { GithubLogo, ArrowsClockwise, Plugs, PlugsConnected } from "@phosphor-icons/react";
...
export default function GitHubRemotePanel({ vaultId }: GitHubRemotePanelProps) {
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md bg-accent px-3 py-2 text-sm font-medium text-white transition-opacity hover:bg-accent-soft disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        <form onSubmit={(e) => void handleConnect(e)} className="space-y-3">
          {!connected && (
            <p className="text-sm text-muted">
              Create a GitHub repo and a personal access token with <strong className="text-ink">Contents</strong> read/write scope.
            </p>
          )}
          <div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              <label className={labelClass} htmlFor="github-subdir">
                Subdirectory <span className="font-normal normal-case text-faint">(optional)</span>
              </label>
              <input
                id="github-subdir"
                type="text"
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md bg-accent px-3 py-2 text-sm font-medium text-white transition-opacity hover:bg-accent-soft disabled:opacity-50"
            >
