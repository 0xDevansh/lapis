...
| SQLite text, conflicts, and binary sealing | [ADR 0010](adr/0010-do-sqlite-text-and-conflict-resolve.md), [ADR 0011](adr/0011-structured-conflict-resolution.md), [ADR 0012](adr/0012-lapis-managed-lfs-pointer-sealing.md), and the accepted [`sqlite-text-and-conflict-ux.md`](proposals/sqlite-text-and-conflict-ux.md) plan |
